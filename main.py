...
from streamlit_highcharts import streamlit_highcharts as st_hc  # importando a função certa
...
alt_chart = (
    ...
    .encode(
        x=alt.X("Date:T", axis=alt.Axis(format="%d/%b/%Y", labelAngle=-90)),
